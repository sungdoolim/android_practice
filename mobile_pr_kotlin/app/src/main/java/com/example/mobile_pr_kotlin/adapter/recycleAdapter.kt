package com.example.mobile_pr_kotlin.adapter
...
class recycleAdapter (val context: Context, val designerList:ArrayList<VO>): RecyclerView.Adapter<recycleAdapter.CustomViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
        ...
        return CustomViewHolder(
            ...
            itemView.setOnLongClickListener(){
                ...
                val dl: VO =designerList.get(curPos)
