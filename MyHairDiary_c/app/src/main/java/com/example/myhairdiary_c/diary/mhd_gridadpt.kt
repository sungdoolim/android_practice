...
//                convertView!!.findViewById<View>(R.id.imV) as ImageView
        ...
        val iv=convertView!!.findViewById<ImageView>(R.id.mhdgrid_myimg)
        val tv=convertView!!.findViewById<TextView>(R.id.mhdgrid_mydesc)
        val isscrab=convertView!!.findViewById<ImageView>(R.id.mhdgrid_myisscrab)
