...
import kotlinx.android.synthetic.main.chec.*
import kotlinx.android.synthetic.main.home.*

class chec:Fragment(), NavigationView.OnNavigationItemSelectedListener, BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    override fun onCreateView(
        ...
        var view= inflater.inflate(R.layout.chec,container,false);
        val transaction= activity?.supportFragmentManager?.beginTransaction()
        val rv=view.findViewById<RecyclerView>(R.id.checked_rv)

        selectList(this)
        val bot=view.findViewById<BottomNavigationView>(R.id.botnav)
        val nav=view.findViewById<NavigationView>(R.id.naviView)

        bot.getMenu().getItem(2).setChecked(true);
